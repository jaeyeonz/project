  ...
  <header class="u-clearfix u-header u-header" id="sec-fe7f"><div class="u-clearfix u-sheet u-sheet-1">
        <nav class="u-align-center u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            ...
            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="FavoriteRecipe?userId=<%=mvo.getUserId() %>" style="padding: 16px 12px;">Home</a></li>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="FavoriteRecipe?userId=<%=mvo.getUserId() %>">Home</a></li>
